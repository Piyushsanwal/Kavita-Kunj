...
<head>
    ...
    <style>
        /*basic css styles */
        body{font-family: 'Times New Roman', Times, serif;margin: 20px;background-color: aqua;}
        h1{color: #333;}
        p{color: #666;}
        blockquote {
...
<body>
    ...
    <blockquote>
        <p>उत्तिष्ठत जाग्रत प्राप्य वरान्निबोधत</p>
        <p class="italic">Arise, awake, and stop not until the goal is reached.</p>
        <footer>
            <cite>Katha Upanishad, II.3</cite>
        </footer>
    </blockquote>      
    <p>App deepo bhavh. Be your Light yourself!</p>
    <script>
     ...
     * in index.handlebars we will make this portal Specific.**/
            ...
            /*This object is used by l10n scripts (page-localized.js, topten-localized.js)to reveal the page content after l10n json is loaded.A timer is also set to prevent JS from hiding page content indefinitelty.This script is inlined to safeguard againt script loading errors and placed at the top of the page to safeguard against any HTML loading/parsing errors.*/
</body>
</html>